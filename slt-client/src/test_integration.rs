    ...
    mod udp_upgrade_flow {
        ...
        async fn register_cid_ok_exchange() {
            ...
            let register = slt_core::proto::RegisterCidPayload {
                ...
                hp_tx: vec![0x01; slt_core::proto::CipherSuite::Aes128Gcm.hp_key_len()],
                hp_rx: vec![0x02; slt_core::proto::CipherSuite::Aes128Gcm.hp_key_len()],
                aead_tx: vec![0x03; slt_core::proto::CipherSuite::Aes128Gcm.aead_key_len()],
                aead_rx: vec![0x04; slt_core::proto::CipherSuite::Aes128Gcm.aead_key_len()],
                iv_tx: [0x05; 12],
                iv_rx: [0x06; 12],
                pn_start: 1000,
                pn_start_rx: 2000,
